...
const Who = () => {
  return (
    <>
      ...
      <div className="w-full h-screen flex  items-center justify-center sticky top-[100px]  bg-[#f1b199]  z-0">
        <div className="w-[50%] h-[100%] flex items-start flex-col justify-center gap-10 ml-10">
          <div className="text-[60px] font-[500]">Who we are?</div>
        ...
        <div className="w-[50%] h-[100%] flex items-center justify-center drop-shadow-md">
          <img
            src="https://images.pexels.com/photos/18130255/pexels-photo-18130255/free-photo-of-fish-in-angler-hand.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
            alt=""
            className="w-[90%]"
          />
        </div>
